#!/usr/bin/env python3
"""
Recuperation des codes promo Nocibe depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/nocibe.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/nocibe.fr"
STORE_NAME = "Nocibe"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Nocibe depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-nocibe)"
    }
    try:
